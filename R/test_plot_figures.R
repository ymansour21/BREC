...
test_plot_figures <- function(chromosome, RR_object, genomeName, chrID, R2DataFrame2D, heteroChromatinBoundaries, swSize, plots_path) {
    ...
    #            ,showlegend = FALSE
    #     )
    # export(p1, file = stringr::str_replace_all( paste(plots_path, genomeName,"- Chr", chrID, "_p1.png"), fixed(" "), ""))
    # print(p1)
    ...
    #            ,showlegend = FALSE
    #     )
    # export(p2, file = stringr::str_replace_all( paste(plots_path, genomeName,"- Chr", chrID, "_p2.png"), fixed(" "), ""))
    # print(p2)
    # #------------------------------------------------------------------
    ...
    #            ,showlegend = FALSE
    #     )
    # export(p3, file = stringr::str_replace_all( paste(plots_path, genomeName,"- Chr", chrID, "_p3.png"), fixed(" "), ""))
    # print(p3)
    # #------------------------------------------------------------------
    ...
    #            ,showlegend = FALSE
    #     )
    # export(p4, file = stringr::str_replace_all( paste(plots_path, genomeName,"- Chr", chrID, "_p4.png"), fixed(" "), ""))
    # print(p4)
    # #------------------------------------------------------------------
    ...
    #            )
    #     )
    # export(p5, file = stringr::str_replace_all( paste(plots_path, genomeName,"- Chr", chrID, "_p5.png"), fixed(" "), ""))
    # print(p5)
    # #------------------------------------------------------------------
    ...
    #            )
    #     )
    # export(p6, file = stringr::str_replace_all( paste(plots_path, genomeName,"- Chr", chrID, "_p6.png"), fixed(" "), ""))
    # print(p6)
    # #------------------------------------------------------------------
    ...
    #            # ,showlegend = FALSE
    #     )
    # export(p7, file = stringr::str_replace_all( paste(plots_path, genomeName,"- Chr", chrID, "_p7.png"), fixed(" "), ""))
    # print(p7)
    #------------------------------------------------------------------
    ...
    p = plot_ly( data = chromosome, x = ~bp, y= ~cM,
                   type = 'scatter', mode = 'markers',
                   yaxis = "y", name = "Experimental data",
                   marker = list(color = "black"), #--------------------------------??????????????????????
                   hoverinfo = text,
    ...
    # orca(p, file = stringr::str_replace_all( paste(plots_path, genomeName,"- Chr", chrID, ".png"), fixed(" "), ""), format = tools::file_ext(file), scale = NULL,
